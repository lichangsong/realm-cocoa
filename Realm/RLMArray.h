...
@class RLMObject, RLMRealm, RLMResults<RLMObjectType: NSObject *>, RLMNotificationToken;
...
@interface RLMArray<RLMObjectType: NSObject *> : NSObject<RLMCollection, NSFastEnumeration>
